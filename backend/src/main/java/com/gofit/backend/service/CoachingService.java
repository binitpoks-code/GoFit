...
public class CoachingService {
    ...
    private final SplitRecommendationService splitRecommendationService;

    public CoachingService(SplitRecommendationService splitRecommendationService) {
        this.splitRecommendationService = splitRecommendationService;
    }

    public CoachingResponse generateRecommendation(UserProfile profile) {
        ...
        SplitRecommendationService.SplitRecommendation splitRecommendation =
                splitRecommendationService.recommendSplit(profile);

        return new CoachingResponse(
                splitRecommendation.getSplitName(),
                splitRecommendation.getReason(),
    ...
    private boolean matches(String value, String firstOption, String secondOption) {
        ...
        return safeValue.equalsIgnoreCase(firstOption)
                || safeValue.equalsIgnoreCase(secondOption);
    }
